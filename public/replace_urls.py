...
# URL original do servidor (que você encontrou)
url_original = 'http://apisdk.mobile.test.ninjaol.com/mnbl/3.4/?'
    ...
    for arquivo in arquivos:
        if arquivo.endswith(".smali"):
            ...
            try:
                ...
                # Faz a substituição
                novo_conteudo = conteudo.replace(url_original, url_nova)
