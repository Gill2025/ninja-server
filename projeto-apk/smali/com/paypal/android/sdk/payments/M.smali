...
.method constructor <init>(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)V
    ...
    iput-object p1, p0, Lcom/paypal/android/sdk/payments/M;->a:Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/payments/M;->a:Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;
    ...
    invoke-virtual {v0, v3}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->setResult(I)V

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/M;->a:Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;

    invoke-virtual {v0}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->finish()V

    goto :goto_0

    :cond_1
    new-instance v0, Lcom/paypal/android/sdk/payments/Q;

    iget-object v1, p0, Lcom/paypal/android/sdk/payments/M;->a:Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;

    invoke-virtual {v1}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->getIntent()Landroid/content/Intent;

    move-result-object v1

    iget-object v2, p0, Lcom/paypal/android/sdk/payments/M;->a:Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;

    invoke-static {v2}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->b(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)Lcom/paypal/android/sdk/payments/PayPalService;
    ...
    invoke-direct {v0, v1, v2}, Lcom/paypal/android/sdk/payments/Q;-><init>(Landroid/content/Intent;Lcom/paypal/android/sdk/payments/PayPalConfiguration;)V

    invoke-virtual {v0}, Lcom/paypal/android/sdk/payments/Q;->d()Z
    ...
    :cond_2
    invoke-virtual {v0}, Lcom/paypal/android/sdk/payments/Q;->e()Z
    ...
    invoke-static {v1, v0}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->a(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;Ljava/util/Date;)Ljava/util/Date;
    ...
    invoke-static {v1}, Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;->a(Lcom/paypal/android/sdk/payments/PayPalFuturePaymentActivity;)Lcom/paypal/android/sdk/payments/Y;
