...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/paypal/android/sdk/at;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/paypal/android/sdk/at;->b:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/paypal/android/sdk/at;->c:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lcom/paypal/android/sdk/at;->a:Ljava/util/Map;
    ...
    sget-object v0, Lcom/paypal/android/sdk/at;->b:Ljava/util/Map;

    const-string v1, "CONSENT_AGREEMENT_FUTURE_PAYMENTS|US"

    const-string v2, "Preapprove future payments made from your <a href=\'%1$s\'>PayPal account</a>."
    ...
    const-string v2, "<h1><strong>Future Payment Agreement</strong></h1><p>PayPal will first use your PayPal balance to pay for purchases. If that doesn\u2019t cover the total, your bank account, PayPal Credit, debit card, credit card, and/or eCheck will be used in that order.</p><p>To cancel this agreement, go to www.paypal.com <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>A small payment authorization may be required to make sure your PayPal account can be charged in the future. The authorization will be voided and you won\u2019t be charged.</p>"
    ...
    sget-object v0, Lcom/paypal/android/sdk/at;->c:Ljava/util/Map;
...
.method public final synthetic a(Ljava/lang/Enum;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lcom/paypal/android/sdk/at;->b:Ljava/util/Map;
