.class public final Lcom/paypal/android/sdk/bg;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Landroid/os/Handler;ZLorg/apache/http/conn/ssl/SSLSocketFactory;)V
    .locals 1

    invoke-direct {p0}, Lcom/paypal/android/sdk/bh;-><init>()V

    iput-object p1, p0, Lcom/paypal/android/sdk/bg;->a:Ljava/lang/String;

    iput-object p2, p0, Lcom/paypal/android/sdk/bg;->b:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/paypal/android/sdk/bg;->c:Ljava/util/List;

    iput-object p3, p0, Lcom/paypal/android/sdk/bg;->d:Landroid/os/Handler;

    iput-boolean p4, p0, Lcom/paypal/android/sdk/bg;->e:Z

    iput-object p5, p0, Lcom/paypal/android/sdk/bg;->f:Lorg/apache/http/conn/ssl/SSLSocketFactory;
...
.method public final run()V
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/bg;->d:Landroid/os/Handler;

    iget-object v1, p0, Lcom/paypal/android/sdk/bg;->d:Landroid/os/Handler;

    iget-object v2, p0, Lcom/paypal/android/sdk/bg;->a:Ljava/lang/String;
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/paypal/android/sdk/bg;->e:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/paypal/android/sdk/bg;->c:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/bg;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v5, v0}, Lorg/apache/http/client/methods/HttpPost;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :goto_2
    :try_start_1
    iget-object v2, p0, Lcom/paypal/android/sdk/bg;->d:Landroid/os/Handler;

    iget-object v3, p0, Lcom/paypal/android/sdk/bg;->d:Landroid/os/Handler;
    ...
    iget-object v2, p0, Lcom/paypal/android/sdk/bg;->f:Lorg/apache/http/conn/ssl/SSLSocketFactory;
    ...
    new-instance v4, Lcom/paypal/android/sdk/bd;

    invoke-direct {v4}, Lcom/paypal/android/sdk/bd;-><init>()V
    ...
    iget-object v4, p0, Lcom/paypal/android/sdk/bg;->f:Lorg/apache/http/conn/ssl/SSLSocketFactory;
    ...
    iget-object v4, p0, Lcom/paypal/android/sdk/bg;->b:Ljava/util/List;
