.class Lc/mpayments/android/c/a/k;
...
.method constructor <init>(Lc/mpayments/android/c/a/j;)V
    ...
    iput-object p1, p0, Lc/mpayments/android/c/a/k;->a:Lc/mpayments/android/c/a/j;
...
.method public run()V
    ...
    iget-object v0, p0, Lc/mpayments/android/c/a/k;->a:Lc/mpayments/android/c/a/j;
    ...
    invoke-virtual {v0}, Lc/mpayments/android/c/a/j;->g()Lc/mpayments/android/b/c;
    ...
    invoke-static {v0}, Lc/mpayments/android/c/a/j;->a(Lc/mpayments/android/c/a/j;)Lc/mpayments/android/b/c;
    ...
    const-string v0, "http://api.centili.com/api/payment/1_2/transaction/continue"

    :goto_0
    new-instance v3, Lc/mpayments/android/util/h;

    iget-object v4, p0, Lc/mpayments/android/c/a/k;->a:Lc/mpayments/android/c/a/j;

    invoke-virtual {v4}, Lc/mpayments/android/c/a/j;->g()Lc/mpayments/android/b/c;
    ...
    invoke-direct {v3, v4, v0}, Lc/mpayments/android/util/h;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    const-string v0, "Content-Type"

    const-string v4, "application/x-www-form-urlencoded"

    invoke-interface {v3, v0, v4}, Lc/mpayments/android/util/p;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "transactionid"

    invoke-interface {v3, v0, v2}, Lc/mpayments/android/util/p;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "Sending parameters \'%s=%s\'"
    ...
    const-string v2, "ContinueTransactionOperation"
    ...
    :try_start_0
    invoke-interface {v3, v0}, Lc/mpayments/android/util/p;->a(I)V

    invoke-interface {v3}, Lc/mpayments/android/util/p;->a()Ljava/lang/String;
    ...
    const-string v4, "ContinueTransactionOperation"
    ...
    invoke-static {v0}, Lc/mpayments/android/c/a/j;->b(Lc/mpayments/android/c/a/j;)Landroid/os/Handler;
    ...
    :cond_0
    const-string v0, "https://api.centili.com/api/payment/1_2/transaction/continue"
    ...
    invoke-interface {v3, v0}, Lc/mpayments/android/util/p;->a(Ljava/lang/String;)V

    iget-object v0, p0, Lc/mpayments/android/c/a/k;->a:Lc/mpayments/android/c/a/j;

    invoke-static {v0}, Lc/mpayments/android/c/a/j;->c(Lc/mpayments/android/c/a/j;)Lc/mpayments/android/b/c;
    ...
    invoke-static {v0}, Lc/mpayments/android/c/a/j;->d(Lc/mpayments/android/c/a/j;)J
