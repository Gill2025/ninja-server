.class final Lio/card/payment/Y;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lio/card/payment/Y;->a:Landroid/graphics/Paint;

    iget-object v0, p0, Lio/card/payment/Y;->a:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lio/card/payment/Y;->b:Landroid/graphics/Bitmap;

    iput-object p1, p0, Lio/card/payment/Y;->d:Landroid/content/Context;
...
.method public final a(Landroid/graphics/Canvas;FF)V
    ...
    iget-object v0, p0, Lio/card/payment/Y;->b:Landroid/graphics/Bitmap;

    if-nez v0, :cond_0

    invoke-virtual {p0, v6}, Lio/card/payment/Y;->a(Z)V
    ...
    iget-object v1, p0, Lio/card/payment/Y;->b:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lio/card/payment/Y;->b:Landroid/graphics/Bitmap;

    new-instance v3, Landroid/graphics/Rect;

    iget-object v4, p0, Lio/card/payment/Y;->b:Landroid/graphics/Bitmap;

    invoke-virtual {v4}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v4

    iget-object v5, p0, Lio/card/payment/Y;->b:Landroid/graphics/Bitmap;
...
.method final a(Z)V
    ...
    iget-boolean v0, p0, Lio/card/payment/Y;->c:Z
    ...
    :cond_0
    iput-boolean p1, p0, Lio/card/payment/Y;->c:Z
    ...
    iget-object v1, p0, Lio/card/payment/Y;->d:Landroid/content/Context;
