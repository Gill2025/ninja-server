...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lio/card/payment/CardScanner;->q:Z

    sput-boolean v2, Lio/card/payment/CardScanner;->b:Z
    ...
    :goto_1
    sput-boolean v2, Lio/card/payment/CardScanner;->p:Z
    ...
    sput-boolean v1, Lio/card/payment/CardScanner;->b:Z
    ...
    sput-boolean v0, Lio/card/payment/CardScanner;->b:Z
    :try_end_2
...
.method constructor <init>(Lio/card/payment/CardIOActivity;I)V
    ...
    iput-boolean v2, p0, Lio/card/payment/CardScanner;->d:Z

    iput v1, p0, Lio/card/payment/CardScanner;->e:I

    iput-boolean v1, p0, Lio/card/payment/CardScanner;->f:Z

    iput-wide v4, p0, Lio/card/payment/CardScanner;->g:J

    iput-wide v4, p0, Lio/card/payment/CardScanner;->h:J

    const/4 v0, 0x0

    iput-object v0, p0, Lio/card/payment/CardScanner;->i:Landroid/hardware/Camera;

    iput-boolean v1, p0, Lio/card/payment/CardScanner;->k:Z
    ...
    iput-object v0, p0, Lio/card/payment/CardScanner;->c:Ljava/lang/ref/WeakReference;

    iput p2, p0, Lio/card/payment/CardScanner;->e:I

    const/high16 v0, 0x40c00000    # 6.0f

    invoke-direct {p0, v2, v0}, Lio/card/payment/CardScanner;->nSetup(ZF)V
...
.method static a()Z
    ...
    sget-boolean v0, Lio/card/payment/CardScanner;->b:Z
...
.method private b(I)Landroid/hardware/Camera;
    ...
    iget-boolean v0, p0, Lio/card/payment/CardScanner;->k:Z
...
.method private b(Landroid/view/SurfaceHolder;)Z
    ...
    sget-boolean v2, Lio/card/payment/CardScanner;->q:Z
    ...
    iget-boolean v2, p0, Lio/card/payment/CardScanner;->k:Z

    if-eqz v2, :cond_2

    :try_start_0
    iget-object v2, p0, Lio/card/payment/CardScanner;->i:Landroid/hardware/Camera;
...
.method private native nGetElapsedClock()J
.end method

.method private native nGetElapsedTime()D
.end method

.method private native nGetFrameCounts([I)V
.end method
...
.method private native nScanFrame([BIIILio/card/payment/DetectionInfo;Landroid/graphics/Bitmap;)V
.end method

.method private native nSetup(ZF)V
.end method

.method private native nSkipFrame()V
.end method
...
.method final a(II)Landroid/graphics/Rect;
    ...
    iget v1, p0, Lio/card/payment/CardScanner;->e:I
...
.method final a(I)V
    ...
    iput p1, p0, Lio/card/payment/CardScanner;->e:I
...
.method final a(Z)V
    ...
    iget-wide v0, p0, Lio/card/payment/CardScanner;->h:J

    iget-wide v2, p0, Lio/card/payment/CardScanner;->g:J
    ...
    iput-wide v0, p0, Lio/card/payment/CardScanner;->g:J

    iget-object v0, p0, Lio/card/payment/CardScanner;->i:Landroid/hardware/Camera;

    invoke-virtual {v0, p0}, Landroid/hardware/Camera;->autoFocus(Landroid/hardware/Camera$AutoFocusCallback;)V

    if-eqz p1, :cond_2

    iget v0, p0, Lio/card/payment/CardScanner;->m:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lio/card/payment/CardScanner;->m:I
...
.method final a(Landroid/view/SurfaceHolder;)Z
    ...
    iget-object v1, p0, Lio/card/payment/CardScanner;->i:Landroid/hardware/Camera;
    ...
    :cond_0
    iget-boolean v1, p0, Lio/card/payment/CardScanner;->k:Z
    ...
    :cond_1
    sget-boolean v1, Lio/card/payment/CardScanner;->q:Z
    ...
    iget-object v1, p0, Lio/card/payment/CardScanner;->j:[B
    ...
    const-string v3, "- bytes per pixel: "
    ...
    iput-object v1, p0, Lio/card/payment/CardScanner;->j:[B

    iget-object v1, p0, Lio/card/payment/CardScanner;->i:Landroid/hardware/Camera;

    iget-object v2, p0, Lio/card/payment/CardScanner;->j:[B
...
.method final b()V
    ...
    iput-wide v2, p0, Lio/card/payment/CardScanner;->g:J

    iput-wide v2, p0, Lio/card/payment/CardScanner;->h:J

    iput v6, p0, Lio/card/payment/CardScanner;->m:I

    iput v6, p0, Lio/card/payment/CardScanner;->n:I
    ...
    invoke-static {v3}, Lio/card/payment/U;->a(Ljava/util/List;)V
...
.method public final c()V
    ...
    iput-object v3, p0, Lio/card/payment/CardScanner;->j:[B

    iput-object v3, p0, Lio/card/payment/CardScanner;->i:Landroid/hardware/Camera;
...
.method public final d()V
    ...
    iput-object v0, p0, Lio/card/payment/CardScanner;->j:[B
...
.method final e()Ljava/util/Map;
    ...
    invoke-direct {p0, v1}, Lio/card/payment/CardScanner;->nGetFrameCounts([I)V

    const-string v2, "num_frames_total"
    ...
    const-string v2, "num_frames_captured"
    ...
    const-string v2, "num_frames_processed"
    ...
    const-string v2, "num_frames_in_focus"
    ...
    const-string v2, "num_frames_scanned"
    ...
    const-string v2, "num_frames_usable"
    ...
    invoke-direct {p0}, Lio/card/payment/CardScanner;->nGetElapsedTime()D
    ...
    const-string v1, "elapsed_clock"

    invoke-direct {p0}, Lio/card/payment/CardScanner;->nGetElapsedClock()J
    ...
    const-string v1, "num_manual_refocusings"

    iget v2, p0, Lio/card/payment/CardScanner;->m:I
    ...
    const-string v1, "num_auto_triggered_refocusings"

    iget v2, p0, Lio/card/payment/CardScanner;->n:I
    ...
    const-string v1, "num_manual_torch_changes"

    iget v2, p0, Lio/card/payment/CardScanner;->o:I
...
.method onEdgeUpdate(Lio/card/payment/DetectionInfo;)V
    ...
    iget-object v0, p0, Lio/card/payment/CardScanner;->c:Ljava/lang/ref/WeakReference;
...
.method public onPreviewFrame([BLandroid/hardware/Camera;)V
    ...
    :cond_1
    sget-boolean v0, Lio/card/payment/CardScanner;->p:Z
    ...
    invoke-direct {p0}, Lio/card/payment/CardScanner;->nSkipFrame()V
    ...
    :cond_2
    sput-boolean v7, Lio/card/payment/CardScanner;->p:Z

    iget-boolean v0, p0, Lio/card/payment/CardScanner;->f:Z

    if-eqz v0, :cond_3

    iput-boolean v8, p0, Lio/card/payment/CardScanner;->f:Z

    iput v7, p0, Lio/card/payment/CardScanner;->e:I
    ...
    invoke-virtual {v0}, Lio/card/payment/CardIOActivity;->a()V
    ...
    iget v4, p0, Lio/card/payment/CardScanner;->e:I

    iget-object v6, p0, Lio/card/payment/CardScanner;->a:Landroid/graphics/Bitmap;

    move-object v0, p0

    move-object v1, p1

    invoke-direct/range {v0 .. v6}, Lio/card/payment/CardScanner;->nScanFrame([BIIILio/card/payment/DetectionInfo;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p0, v8}, Lio/card/payment/CardScanner;->a(Z)V
    ...
    :cond_5
    sput-boolean v8, Lio/card/payment/CardScanner;->p:Z
    ...
    :cond_7
    invoke-virtual {v5}, Lio/card/payment/DetectionInfo;->a()Z
    ...
    invoke-virtual {v5}, Lio/card/payment/DetectionInfo;->b()Lio/card/payment/CreditCard;
    ...
    iget-object v1, p0, Lio/card/payment/CardScanner;->a:Landroid/graphics/Bitmap;
